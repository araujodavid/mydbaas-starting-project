package main.java.br.com.arida.ufc.mydbaas.driver.collector;
...
import main.java.br.com.arida.ufc.mydbaas.driver.client.MyDriverClient;
import main.java.br.com.arida.ufc.mydbaas.driver.manager.MyDBaaSConnection;
import main.java.br.com.arida.ufc.mydbaas.driver.util.SendResquest;
...
public abstract class AbstractWorkloadCollector<T extends AbstractDatabaseMetric> {
	 ...
	 */
	public AbstractWorkloadCollector(MyDriverClient client, Properties properties) {
		this.client = client;
...
//		String key = StringUtils.decapitalize(this.getClass().getSimpleName().replace("Collector", "").concat(".url"));
//		if (properties.containsKey(key)) {
//			this.url = properties.getProperty(key);
//		}
	}
